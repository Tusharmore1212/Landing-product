...
Iris WP is an innovative,  easily customizable, multi-purpose theme, focused on empowering users to build astonishing WordPress websites. Iris WP is mainly designed for small businesses, startups, or personal portfolio websites and works perfectly with Kubio Page Builder which enriches the WordPress block editor with a variety of new blocks and advanced styling options to give you full design freedom.

== Frequently Asked Questions ==

= How can I customize Iris WP? =

    To customize the Iris WP theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Iris WP WordPress theme, Copyright (C) 2021 ExtendThemes
Iris WP WordPress theme is licensed under the GPL3.
